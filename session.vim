...
silent only
silent tabonly
cd ~/github/genius1512/fastserver
...
wincmd w
argglobal
if bufexists("scripts/server.py") | buffer scripts/server.py | else | edit scripts/server.py | endif
balt scripts/logger.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("scripts/client.py") | buffer scripts/client.py | else | edit scripts/client.py | endif
balt scripts/logger.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
terminal ++curwin ++cols=190 ++rows=24 
...
exe '4resize ' . ((&lines * 8 + 25) / 51)
tabnext 1
badd +3 scripts/__main__.py
badd +38 scripts/logger.py
badd +0 scripts/server.py
badd +0 scripts/client.py
