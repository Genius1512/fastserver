...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 25 + 17) / 34)
exe 'vert 1resize ' . ((&columns * 62 + 67) / 135)
exe '2resize ' . ((&lines * 25 + 17) / 34)
exe 'vert 2resize ' . ((&columns * 72 + 67) / 135)
...
wincmd w
argglobal
terminal ++curwin ++cols=135 ++rows=16 
